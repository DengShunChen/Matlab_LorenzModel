...
%------------------------------------------------------------
 ...
 prefix.model.type            = 3; 
 prefix.model.maxtime		      = 40;

 prefix.reduced_factor		    =4;
...
%===============================================================================================%
 ...
 elseif  prefix.model.type ==3 & prefix.model.main.I==12
   ...
   prefix.da.assim_bin.main	    =20;

   file_Init_Truth              ='data_genmem_truth_M03.mat'
   file_Init_Bck                ='data_genmem_bckgd_M03.mat'
   file_Init_Bck_Ens            ='data_genmem_bck_ens_M03_m200.mat'

   file_truth                   ='data_genmem_truth_M03_p125.txt';
   file_obsdata                 ='data_genmem_obsdata_M03_p125.txt';
   file_obsposi                 ='data_genmem_obsposi_M03_p125.txt';
 else
...
if strcmp(prefix.da.system,'3DVAR') || strcmp(prefix.da.system,'3DHYB')
  ...
  if strcmp(prefix.da.type,'sdl') || strcmp(prefix.da.type,'msda')
    ...
    BEV=(diag(Bs_l)/wgt);
    prefix.da.Bs.l=prefix.da.L.l*diag(BEV);

    %wgt=mean(diag(Bs_s))/(prefix.da.observation_error/10.);
    BEV=(diag(Bs_s)/wgt);
    prefix.da.Bs.s=prefix.da.L.s*diag(BEV);
  else
    wgt=mean(diag(B))/prefix.da.observation_error;
    BEV=(diag(B)/wgt);
    prefix.da.Bs=prefix.da.L*diag(BEV);
  end
end
